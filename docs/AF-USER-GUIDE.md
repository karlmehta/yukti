...
These three were measured on Android; their iOS halves are written and not yet
run, so treat an iOS failure in them as a bug in the tool before doubting the app.
